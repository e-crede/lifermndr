...
class RemindersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create reminder" do
    assert_difference("Reminder.count") do
      post reminders_url, params: { reminder: { active: @reminder.active, date: @reminder.date, hour: @reminder.hour, name: @reminder.name, period: @reminder.period, recurrence: @reminder.recurrence } }
    end
  ...
  test "should update reminder" do
    patch reminder_url(@reminder), params: { reminder: { active: @reminder.active, date: @reminder.date, hour: @reminder.hour, name: @reminder.name, period: @reminder.period, recurrence: @reminder.recurrence } }
